...
class Footer extends React.Component{
    ...
    makeList = (items) => {
        ...
        return <li className="list-unstyled" ><Icon iconName={item.icon_name}/><Link style={{color:"#DEE2E6"}} to={item.path}>{item.title}</Link></li>
        });
    }
    ...
    render(){
        ...
        return (
            <footer  className="font-small pt-4 mt-4 pl-2" style={{backgroundColor:"#343A40", color:"#FFFFFF" }}>
              <div fluid className="text-md-left">
                <div className="row">
